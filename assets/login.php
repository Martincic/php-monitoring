...
<form action='switch.php' method='post' class='w-50 mt-5 mx-auto'>
    ...
    <button type='submit' class='btn <?php echo $color1 ?> btn-lg btn-block'>SWITCH LIGHTS</button>
</form>
...
<form action='switch.php' method='post' class='w-50 mt-5 mx-auto'>
    ...
    <button type='submit' class='btn <?php echo $color2 ?> btn-lg btn-block'>SWITCH LIGHTS</button>
</form>